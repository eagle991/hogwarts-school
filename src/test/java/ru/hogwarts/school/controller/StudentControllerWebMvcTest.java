...
class StudentControllerWebMvcTest {
    ...
    @Test
    void findByAgeBetween_shouldReturnStudentsInAgeRange() throws Exception {
    ...
    @Test
    void getFacultyByStudentId_shouldReturnNotFound() throws Exception {
        when(studentService.getFacultyByStudentId(999L))
