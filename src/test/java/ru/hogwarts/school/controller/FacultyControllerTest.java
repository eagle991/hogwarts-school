...
class FacultyControllerTest {
    ...
    void updateFaculty_shouldReturnUpdatedFaculty() throws Exception {
        ...
        when(facultyService.editFaculty(any())).thenReturn(updated);
    ...
    void findByColor_shouldReturnFaculties() throws Exception {
        when(facultyService.findByColor("Red")).thenReturn(List.of(gryffindor));
    ...
    void findByName_shouldReturnFaculty() throws Exception {
        when(facultyService.findByName("Gryffindor")).thenReturn(Optional.of(gryffindor));
